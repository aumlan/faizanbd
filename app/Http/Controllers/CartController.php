...
class CartController extends Controller
{
    ...
    public function updateAddedCart(Request $request)
    {
        return view('frontend.partials.addedcart');
    }
    ...
    public function updateShipping(Request $request)
    {
        ...
        $ship=Address::where('id',$request->shipping)->first();
        if($ship->city=='Dhaka-North' || $ship->city=='Dhaka-South'){
            $shipping_cost='60';
        }
        else{
            $shipping_cost='100';
        ...
        $cart = $request->session()->get('cart', collect([]));
        $cart = $cart->map(function ($object, $key) use ($shipping_cost) {
            
                $object['shipping'] = $shipping_cost;
