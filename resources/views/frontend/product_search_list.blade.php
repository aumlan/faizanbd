<div class="products-box-bar p-3 bg-white rep">
    ...
    width: 100%;
    left: 0px;box-shadow: 2px 4px 6px #aaa;display: none"><a itemprop="url"  onclick="addToListCart({{ $product->id }})" title="Add to cart" style="width: 90%;font-size: 14px;padding: 5px;color: #fff" class="btn btn-styled btn-base-1 btn-icon-left strong-700 hov-bounce hov-shaddow buy-now">Add to cart</a></div>
                                            </div>
