                    ...
                    <div class="main-content">
                        ...
                        <form class="" action="{{ route('shops.update', $shop->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <input id="sample_search" type="text" class="form-control mb-3" placeholder="{{__('Shop url')}}" name="slug" value="{{ $shop->slug }}" required>
                            ...
                            <div class="text-right mt-4">
                                <button type="submit" id="shopb" class="btn btn-styled btn-base-1 shopbt">{{__('Save')}}</button>
                            </div>
                        </form>
