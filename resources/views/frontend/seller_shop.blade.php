                ...
                <div class="home-slide">
                    <div class="slick-carousel" data-slick-arrows="true" data-slick-dots="true">
                        ...
                        <div class="">
                            ...
                            @if ($img=\App\Banner::where('position', '100')->first())
                            
                                    <img class="d-block w-100 lazyload" src="{{ asset('frontend/images/placeholder-rect.jpg') }}" data-src="{{ asset($img->photo) }}" alt="slide" style="max-height:300px;">
                                </div>
                                @endif
                        @endif
                                            ...
                                            <div class="card-body p-0">
                                                ...
                                                <div class="card-image">
                                                    <a href="{{ route('product', $product->slug) }}" class="d-block">
                                                        <img  class="mx-auto img-fit lazyload" src="{{ asset('frontend/images/placeholder.jpg') }}" data-src="{{ asset($product->featured_img ?? $product->thumbnail_img) }}" alt="{{ __($product->name) }}">
                                                    </a>
                                                </div>
