                ...
                <div class="col-lg-6">
                    <table class="details-table table">
                        ...
                        <tr>
                            ...
                            <td>{{ json_decode($order->shipping_address)->address ?? '' }}, {{ json_decode($order->shipping_address)->city ?? '' }}, {{ json_decode($order->shipping_address)->postal_code ?? '' }}, {{ json_decode($order->shipping_address)->city ?? '' }}</td>
                        </tr>
                    </table>
                </div>
                <div class="col-lg-6">
                    ...
                    <table class="table details-table">
                        <tbody>
                            ...
                            <tr>
                                <th>{{__('Advance')}}</th>
                                <td class="text-right">
                                    <span class="text-italic">{{ single_price($order->reseller_adv) }}</span>
                                </td>
                            </tr>
                            <tr>
