                    ...
                    <div class="main-content">
                        ...
                        <div class="page-title">
                            ...
                            <div class="row align-items-center pt-2" >
                                    ...
                                    <div id="reportrange"  class="form-control pull-left" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc;">
    <i class="glyphicon glyphicon-calendar fa fa-calendar"></i>&nbsp;
    <span></span><div></div> <b class="caret"></b>
</div>
...
<<script>
    ...
    function cb(start, end) {
        ...
        $('#reportrange div').html('<input type="hidden" name="start" value="'+start.format('YYYY-M-D') +'"><input type="hidden" name="end" value="'+end.format('YYYY-M-D') +'">');
    ...
    $('#reportrange').click(function(){
        $('.opensright').css({opacity:"1",visibility:"visible"});
    });
