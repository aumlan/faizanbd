        ...
        <div class="widget-balance pb-3 pt-1">
            ...
            <div class="text-center">
                <div class="heading-4 strong-700 mb-4">
                    ...
                    @endphp
                    <small class="d-block text-sm alpha-5 mb-2">{{__('Your profit amount (current month)')}}</small>
            ...
            @elseif(Auth::user()->role==3 || Auth::user()->role==1)
