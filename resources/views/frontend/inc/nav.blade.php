            ...
            <div class="row">
                ...
                <div class="col-5 text-right d-none d-lg-block">
                    <ul class="inline-links">
                        ...
                        @auth
                        <li>
                            <a href="{{ route('dashboard') }}" class="top-bar-item">My Panel</a>
                        </li>
                        <li>
                        ...
                        @else
                        <li>
                            <a href="{{ route('shops.create') }}" class="top-bar-item btn-base-1 text-white" style="border-radius: 5px;padding: 7px;font-weight: bold;">Be A Seller</a>
                        </li>
        ...
        <li>
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        @foreach($category->subcategories as $data2)
                    ...
                    <ul class="side-user-menu">
                        ...
                        @else
                         <div class="mt-4">
                                ...
                                <a style="margin: 0px 35px;color: #fff" href="{{route('shops.create')}}" class="btn btn-base-1 btn-icon-left">
                                    Apply Now
                                </a>
                            </div>
                        @endauth
                            ...
                            <div class="search-box flex-grow-1 px-4" style="padding-left: 0px !important">
                                <form action="{{ route('search') }}" method="GET">
                                    <div class="d-flex position-relative">
                                        ...
                                        <div class="w-100">
                                            <input type="text" aria-label="Search" id="search" name="q" class="w-100" placeholder="{{__('Search Products...')}}" autocomplete="off">
                                        </div>
                                                                        ...
                                                                        <div class="d-flex align-items-center">
                                                                            <div class="dc-image">
                                                                                <a href="{{ route('product', $product->slug) }}">
                                                                                    <img src="{{ asset('frontend/images/placeholder.jpg') }}" data-src="{{ asset($product->featured_img) }}" class="img-fluid lazyload" alt="{{ __($product->name) }}">
                                                                                </a>
                                                                            </div>
            ...
            <div class="col-lg-12 position-static order-2 order-lg-0 d-none d-lg-block">
                <div class="category-sidebar" style="text-align: center">
                    ...
                    <ul class="categories no-scrollbar d-inline-flex">
                        ...
                        @foreach (\App\Category::all()->sortBy('sort_n')->take(8) as $key => $category)
                            @php
                                $brands = array();
                            @endphp
                            <li class="category-nav-element" data-id="{{ $category->id }}">
