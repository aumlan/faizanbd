                ...
                <div class="col">
                    <ul class="breadcrumb">
                        ...
                        @if(isset($detailedProduct->category))
                            <li><a href="{{ route('products.category', $detailedProduct->category->slug) }}">{{ $detailedProduct->category->name }}</a></li>
                        @endif
                        @if(isset($detailedProduct->subcategory))
                            <li><a href="{{ route('products.category', $detailedProduct->subcategory->slug) }}">{{ $detailedProduct->subcategory->name }}</a></li>
                        @endif
                        @if(isset($detailedProduct->subsubcategory))
                            <li><a href="{{ route('products.category', $detailedProduct->subsubcategory->slug) }}">{{ $detailedProduct->subsubcategory->name }}</a></li>
                        @endif
                        
                        <li class="active text-truncate"><a href="{{ route('product', $detailedProduct->slug) }}">{{__($detailedProduct->name)}}</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white">
                    ...
                    <div class="col-lg-5 mb-1">
                        <div class="product-gal sticky-top d-flex flex-row-reverse">
                                ...
                                <div class="product-gal-img">
                                    <img src="{{ asset('frontend/images/placeholder.jpg') }}" class="xzoom img-fluid lazyload" src="{{ asset('frontend/images/placeholder.jpg') }}" data-src="{{ asset($detailedProduct->featured_img) }}" xoriginal="{{ asset($detailedProduct->featured_img) }}" />
                                ...
                                <div class="product-gal-thumb d-lg-block">
                                    <div class="xzoom-thumbs">
                                        {{-- <a href="{{ asset($detailedProduct->featured_img) }}">
                                                <img src="{{ asset('frontend/images/placeholder.jpg') }}" class="xzoom-gallery lazyload" src="{{ asset('frontend/images/placeholder.jpg') }}" width="80" data-src="{{ asset($detailedProduct->featured_img) }}" xpreview="{{ asset($detailedProduct->featured_img) }}" >
                                            </a> --}}
                        ...
                        <div class="product-description-wrapper">
                            ...
                            <div class="row align-items-center my-1">
                                <div class="col-6">
                                    ...
                                    <h5>SKU :   {{__($detailedProduct->sku)}}</h5>
                            ...
                            @if(auth()->user()->user_type=='seller')
                                ...
                                <div class="row no-gutters mt-3">
                                    <div class="col-3">
                                        <div class="product-description-label">{{__('Wholesale')}}:</div>
                                    </div>
                                    <div class="col-9">
                                        <div class="product-price">
                                            <strong>
                                                {{ home_reseller_discounted_base_price($detailedProduct->id) }}
                                            </strong>
                                            <span class="piece">/{{ $detailedProduct->unit }}</span>
                                        </div>
                                    </div>
                ...
                @endphp
                        <div class="row no-gutters mt-3 ">
                                    ...
                                    <div class="col-6">
                                        <a href="tel:{{ $generalsetting->phone }}" target="_blank">
                        ...
                        @php
                            ...
                            {{__('Recently viewed products')}}
                            	...
                            	@endphp
                            	@foreach (Session::get('recent_view') as $cartItem)
                            	@php
                            	// print_r($cartItem['id']);
                            	// die();
                                ...
                                <div class="clearfix">
                                    <div class="product-image float-left">
                                        <a href="{{ route('product', $top_product->slug) }}">
                                            <img class="img-fit lazyload" src="{{ asset('frontend/images/placeholder.jpg') }}" data-src="{{ asset($top_product->featured_img) }}" alt="{{ __($top_product->name) }}">
                                        </a>
                                    </div>
                    ...
                    <div class="product-desc-tab bg-white">
                        <div class="tabs tabs--style-2">
                            <ul class="nav nav-tabs justify-content-left sticky-top bg-white">
                                ...
                                <li class="nav-item">
                                    <a href="#tab_default_5" data-toggle="tab" class="nav-link text-uppercase strong-600">{{__('Shipping Info')}}</a>
                                </li>
                            </ul>
                                    ...
                                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-4 p-0">
                                        ...
                                        <div class="product-box-2 bg-white alt-box my-md-2 product-hover mr-lg-1 ml-lg-1 ml-0 mr-0" style="">
                                            <div class="position-relative overflow-hidden">
                                                <a href="{{ route('product', $related_product->slug) }}" class="d-block product-image h-100 text-center" tabindex="0">
                                                    <img class="img-fit lazyload" src="{{ asset('frontend/images/placeholder.jpg') }}" data-src="{{ asset($related_product->featured_img ?? $related_product->featured_img) }}" alt="{{ __($related_product->name) }}">
                                                </a>
                                                <div class="product-btns clearfix">
                                                    <button class="btn add-wishlist" title="Add to Wishlist" onclick="addToWishList({{ $related_product->id }})" type="button">
                                                        <i class="la la-heart-o"></i>
                                                    </button>
                                                    <button class="btn add-compare" title="Add to Compare" onclick="addToCompare({{ $related_product->id }})" type="button">
                                                        <i class="la la-refresh"></i>
                                                    </button>
                                                    <button class="btn quick-view" title="Quick view" onclick="showAddToCartModal({{ $related_product->id }})" type="button">
                                                        <i class="la la-eye"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="p-md-2 p-2">
                                                ...
                                                <h2 class="product-title p-0">
                                                    <a href="{{ route('product', $related_product->slug) }}" class=" text-truncate">{{ __($related_product->name) }}</a>
                                                </h2>
                                                ...
                                                @endif
                                                 <div class="padding_0 add-cart-b" style=""><a itemprop="url"  onclick="addToListCart({{ $related_product->id }})" title="Add to cart" style="" class="add-cart-ab btn btn-styled btn-base-1 btn-icon-left strong-700 hov-bounce hov-shaddow buy-now">Add To Cart</a></div>
                                            </div>
