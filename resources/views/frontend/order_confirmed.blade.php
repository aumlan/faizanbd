                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <table class="details-table table">
                                                ...
                                                <tr>
                                                    <td class="w-50 strong-600">{{__('Shipping Area')}}:</td>
                                                    <td>{{ $order->shipping_area }}</td>
                                                </tr>
                                                <tr>
                                                    <td class="w-50 strong-600">{{__('Shipping address')}}:</td>
                                                    <td>{{ json_decode($order->shipping_address)->address }} {{ json_decode($order->shipping_address)->city }} {{ json_decode($order->shipping_address)->region ?? '' }}</td>
                                                </tr>
                                            </table>
                                        </div>
                                        <div class="col-md-6">
