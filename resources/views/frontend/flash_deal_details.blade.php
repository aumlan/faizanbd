                        ...
                        @if ($product->published != 0)
                            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-image">
                                            <a href="{{ route('product', $product->slug) }}" class="d-block text-center" >
                                                <img class="img-fit lazyload" src="{{ asset('frontend/images/placeholder.jpg') }}" data-src="{{ asset($product->flash_deal_img ?? $product->featured_img) }}" alt="{{ __($product->name) }}">
                                            </a>
                                        </div>
                                ...
                                <input type="hidden" name="id" value="{{ $product->id }}">
                                        <button type="button" class="btn btn-styled btn-alt-base-1 c-white btn-icon-left strong-700 hov-bounce hov-shaddow ml-2 add-to-cart" onclick="addToListCart({{ $product->id }})">
