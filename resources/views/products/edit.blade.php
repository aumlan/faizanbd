		...
		<form class="form form-horizontal mar-top" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
			...
			<div class="panel">
				...
				<div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label">{{__('Wholesale price')}}</label>
                        <div class="col-lg-7">
                            <input type="number" min="0" step="0.01" placeholder="{{__('Wholesale price')}}" name="wholesale_price" class="form-control" value="{{$product->wholesale_price}}" required>
                        </div>
                    </div>
                    <div class="form-group">
