                ...
                @foreach($sellers as $key => $seller)
                    @if($seller->user != null)
                        <tr>
                            ...
                            <td>
                                Request for: 
                                 @if ($seller->user->role==2)
                                 Reseller
                                 @elseif($seller->user->role==3)
                                 Seller
                                 @else
                                 Both
                                 @endif
                            ...
                            <td>
                                <div class="btn-group dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <li><a onclick="show_url_modal('{{$seller->user_id}}');">{{__('Shop Url Modify')}}</a></li>
...
@section('script')
    <script type="text/javascript">
        ...
        function show_url_modal(id){
               ...
               $.post('{{ route('sellers.shopurl_modal') }}',{_token:'{{ @csrf_token() }}', id:id}, function(data){
