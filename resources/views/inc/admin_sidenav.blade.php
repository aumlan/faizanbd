                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li class="{{ areActiveRoutes(['brands.index', 'brands.create', 'brands.edit'])}}">
                                        <a target="_blank" class="nav-link" href="{{route('brands.index')}}">{{__('Brand')}}</a>
                                    </li>
                                    <li class="{{ areActiveRoutes(['categories.index', 'categories.create', 'categories.edit'])}}">
                                        <a target="_blank" class="nav-link" href="{{route('categories.index')}}">{{__('Category')}}</a>
                                    </li>
                                    <li class="{{ areActiveRoutes(['subcategories.index', 'subcategories.create', 'subcategories.edit'])}}">
                                        <a target="_blank" class="nav-link" href="{{route('subcategories.index')}}">{{__('Subcategory')}}</a>
                                    </li>
                                    <li class="{{ areActiveRoutes(['subsubcategories.index', 'subsubcategories.create', 'subsubcategories.edit'])}}">
                                        <a target="_blank" class="nav-link" href="{{route('subsubcategories.index')}}">{{__('Sub Subcategory')}}</a>
                                    </li>
...
{{--                                        <a class="nav-link" href="{{route('products.admin')}}">{{__('In House Products')}}</a>--}}
                                        <a target="_blank" class="nav-link" href="{{route('products.admin')}}">Products List</a>
                                    </li>
                                    <li class="{{ areActiveRoutes(['reseller_deals.store', 'reseller_deals.create', 'reseller_deals.index'])}}">
                                        <a target="_blank" class="nav-link" href="{{route('reseller_deals.index')}}">{{__('Whole Sale Products')}}</a>
                                    </li>
...
{{--                                <span class="menu-title">{{__('Inhouse orders')}} @if($orders > 0)<span class="pull-right badge badge-info">{{ $orders }}</span>@endif</span>--}}
                                <span class="menu-title">Orders @if($orders > 0)<span class="pull-right badge badge-info">{{ $orders }}</span>@endif</span>
                            </a>
                        </li>
                        @endif
...
{{--                                <span class="menu-title">{{__('ReSellers')}}</span>--}}
                            ...
                            <ul class="collapse">
                                ...
                                <li class="{{ areActiveRoutes(['shop_default_slider'])}}">
                                    <a class="nav-link" href="{{ route('shop_default_slider') }}">{{__('Shop Default Slider')}}</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                ...
                                <li class="{{ areActiveRoutes(['menu.index'])}}">
