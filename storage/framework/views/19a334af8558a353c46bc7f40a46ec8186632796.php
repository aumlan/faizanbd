            ...
            <div class="product-gal sticky-top d-flex flex-row-reverse">
                <?php if(is_array(json_decode($product->photos)) && count(json_decode($product->photos)) > 0): ?>
                    <div class="product-gal-img">
                        <img src="<?php echo e(asset('frontend/images/placeholder.jpg')); ?>" class="xzoom img-fluid lazyload"
                             src="<?php echo e(asset('frontend/images/placeholder.jpg')); ?>"
                             data-src="<?php echo e(asset(json_decode($product->photos)[0])); ?>"
                             xoriginal="<?php echo e(asset(json_decode($product->photos)[0])); ?>"/>
                    </div>
                        ...
                        <div class="xzoom-thumbs">
                            <?php $__currentLoopData = json_decode($product->photos); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(asset($photo)); ?>">
                                    <img src="<?php echo e(asset('frontend/images/placeholder.jpg')); ?>"
                                         class="xzoom-gallery lazyload"
                                         src="<?php echo e(asset('frontend/images/placeholder.jpg')); ?>" width="80"
                                         data-src="<?php echo e(asset($photo)); ?>"
                                         <?php if($key == 0): ?> xpreview="<?php echo e(asset($photo)); ?>" <?php endif; ?>>
                                </a>
                            ...
                            <div class="col-10">
                                <div class="product-quantity d-flex align-items-center">
                                    ...
                                    <div class="avialable-amount">(<span
                                            id="available-quantity"><?php echo e($qty); ?></span> <?php echo e(__('available')); ?>)
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="d-table-cell">
                        ...
                        <?php if($product->digital == 1): ?>
                            <button type="button"
                                ...
                                <span class="d-md-inline-block"> <?php echo e(__('Buy Now')); ?></span>
                            </button>
                        <?php elseif($qty > 0): ?>
                            <button type="button"
                                    class="btn btn-styled btn-alt-base-1 c-white btn-icon-left strong-700 hov-bounce hov-shaddow ml-2 add-to-cart"
...
<?php /**PATH /home/idevsoft/faizanbd.com/resources/views/frontend/partials/addToCart.blade.php ENDPATH**/ ?>