...
<div class="header">
    <div class="bottom-navbar d-block d-lg-none" style="padding-bottom: 0px;padding-left: 15px;">
        ...
        <li>
            <div style="text-align: -webkit-center;padding-top: 8px" class="">
                                ...
                                <a href="<?php echo e(route('categories.all')); ?>">
                                    <img class="nav-box-icon" src="<?php echo e(asset('img/cat.png')); ?>" style="width:20px;padding-bottom: 3px ">
        ...
        <li>
            <a class="nav-cart-box" href="<?php echo e(route('products')); ?>">
                <img class="nav-box-icon" src="<?php echo e(asset('img/shop.png')); ?>" style="width:27px;padding-bottom: 3px ">
                <div >Shop</div>
            </a>
        </li>
            ...
            <div class="row">
                    ...
                    <ul class="inline-links d-lg-inline-block d-flex justify-content-between">
                        <li class="dropdown" id="lang-change">
                            ...
                            <a href="" class="dropdown-toggle top-bar-item" data-toggle="dropdown">
                                <img src="<?php echo e(asset('frontend/images/placeholder.jpg')); ?>" height="11" data-src="<?php echo e(asset('frontend/images/icons/flags/'.$locale.'.png')); ?>" class="flag lazyload" alt="<?php echo e(\App\Language::where('code', $locale)->first()->name); ?>" height="11"><span class="language"><?php echo e(\App\Language::where('code', $locale)->first()->name); ?></span>
                            </a>
                            <ul class="dropdown-menu">
                                <?php $__currentLoopData = \App\Language::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="dropdown-item <?php if($locale == $language): ?> active <?php endif; ?>">
                                        <a href="#" data-flag="<?php echo e($language->code); ?>"><img src="<?php echo e(asset('frontend/images/placeholder.jpg')); ?>" data-src="<?php echo e(asset('frontend/images/icons/flags/'.$language->code.'.png')); ?>" class="flag lazyload" alt="<?php echo e($language->name); ?>" height="11"><span class="language"><?php echo e($language->name); ?></span></a>
                                    </li>
                ...
                <div class="col-5 text-right d-none d-lg-block">
                    <ul class="inline-links">
                        ...
                        <!--    <li>-->
                        <!--        <a href="<?php echo e(route('affiliate.apply')); ?>" class="top-bar-item"><?php echo e(__('Be an affiliate partner')); ?></a>-->
                        <!--    </li>-->
                        <!--<?php endif; ?>-->
                        
                        <?php if(auth()->guard()->check()): ?>
                        <li>
                            <a href="<?php echo e(route('dashboard')); ?>" class="top-bar-item">My Panel</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('logout')); ?>" class="top-bar-item">Logout</a>
                        </li>
                        <?php else: ?>
                        <li>
                            <a href="<?php echo e(route('shops.create')); ?>" class="top-bar-item btn-base-1 text-white" style="border-radius: 5px;padding: 7px;font-weight: bold;">Be A Seller</a>
                        </li>
...
<nav class="menu d-lg-none">
    ...
    <ul class="collapse">
        <div class="side-menu-header ">
                    <div class="side-menu-close" onclick="sideCatClose()">
                        ...
                        <div class="side-login px-3 pb-3">
                            <a href=""><?php echo e(__('')); ?></a>
                            <a style="font-size: 16px" href="<?php echo e(route('categories.all')); ?>"><?php echo e(__('Categories')); ?></a>
                        </div>
                </div>
        <?php $__currentLoopData = \App\Category::all()->sortBy('sort_n')->take(11); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $brands = array();
                                ?>
        ...
        <li>
            ...
            <ul>
                <?php $__currentLoopData = $category->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                    <a href="<?php echo e(route('products.subcategory', $data->slug)); ?>"><?php echo e($data->name ?? ''); ?></a>
                    <?php if(count($data->subsubcategories)>0): ?>
                    <ul>
                        <?php $__currentLoopData = $category->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li><a href="<?php echo e(route('products.subsubcategory', $data2->slug)); ?>"><?php echo e($data2->name); ?></a></li>
                       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                    <?php endif; ?>
                </li>
                ...
                <div class="side-menu-list px-3">
                    <ul class="side-user-menu">
                        ...
                        <?php else: ?>
                         <div class="mt-4">
                                ...
                                <a style="margin: 0px 35px;color: #fff" href="<?php echo e(route('shops.create')); ?>" class="btn btn-base-1 btn-icon-left">
                                    Apply Now
                                </a>
                            </div>
                        <?php endif; ?>
                    ...
                    <ul class="side-seller-menu">
                            ...
                            <li>
                                ...
                                <img class="cat-image lazyload" src="
                    </ul> -->
                </div>
            </div>
        </div>
    ...
    <div class="menu-toggle d-block d-lg-none mobile-menu-icon-box">
                    ...
                    <div class="col-lg-9 col-2 position-static">
                        <div class="d-flex w-100">
                            <div class="search-box flex-grow-1 px-4" style="padding-left: 0px !important">
                                <form action="<?php echo e(route('search')); ?>" method="GET">
                                    <div class="d-flex position-relative">
                                        ...
                                        <div class="w-100">
                                            <input type="text" aria-label="Search" id="search" name="q" class="w-100" placeholder="<?php echo e(__('Search Products...')); ?>" autocomplete="off">
                                        </div>
                            ...
                            <div class="logo-bar-icons d-inline-block ml-auto">
                                ...
                                <!--            <i class="la la-retweet d-inline-block nav-box-icon"></i>-->
                                                                        ...
                                                                        <div class="d-flex align-items-center">
                                                                            <div class="dc-image">
                                                                                <a href="<?php echo e(route('product', $product->slug)); ?>">
                                                                                    <img src="<?php echo e(asset('frontend/images/placeholder.jpg')); ?>" data-src="<?php echo e(asset($product->featured_img)); ?>" class="img-fluid lazyload" alt="<?php echo e(__($product->name)); ?>">
                                                                                </a>
                                                                            </div>
        ...
        <div class="row no-gutters ">
            <div class="col-lg-12 position-static order-2 order-lg-0 d-none d-lg-block">
                <div class="category-sidebar" style="text-align: center">
                    ...
                    <ul class="categories no-scrollbar d-inline-flex">
                        <li class="d-lg-none">
                            <a href="<?php echo e(route('categories.all')); ?>">
                        ...
                        <?php $__currentLoopData = \App\Category::all()->sortBy('sort_n')->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $brands = array();
                            ?>
                            <li class="category-nav-element" data-id="<?php echo e($category->id); ?>">
                                ...
                                <?php if(count($category->subcategories)>0): ?>
                                    <div class="sub-cat-menu c-scrollbar" style="left: 3% !important;top: 165px !important;max-height: 400px !important;">
                                        <div class="c-preloader">
                                            <i class="fa fa-spin fa-spinner"></i>
                                        </div>
                                    </div>
                        ...
                        <li class="category-nav-element">
                            <a href="<?php echo e(route('categories.all')); ?>">
                                <img class="cat-image lazyload" src="<?php echo e(asset('frontend/images/placeholder.jpg')); ?>" data-src="<?php echo e(asset('frontend/images/icons/list.png')); ?>" width="30" alt="<?php echo e(__('All Category')); ?>">
                                <span class="cat-name"><?php echo e(__('All')); ?> <?php echo e(__('Categories')); ?></span>
                            </a>
                        </li>
                    </ul>
                </div>
...
<?php /**PATH /home/idevsoft/faizanbd.com/resources/views/frontend/inc/nav.blade.php ENDPATH**/ ?>