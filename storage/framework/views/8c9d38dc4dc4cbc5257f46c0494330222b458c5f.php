                        ...
                        <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php $__currentLoopData = \App\HomeCategory::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $home_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($home_category->category != null): ?>
                                        <tr>
                                            <td><?php echo e($key+1); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idevsoft/faizanbd.com/resources/views/home_settings/index.blade.php ENDPATH**/ ?>