...
<!-- Favicon -->
<link type="image/x-icon" href="<?php echo e(asset(\App\GeneralSetting::first()->favicon)); ?>" rel="shortcut icon" />
...
<!-- Icons -->
<link rel="stylesheet" href="<?php echo e(asset('frontend/css/font-awesome.min.css')); ?>" type="text/css" media="none" onload="if(media!='all')media='all'">
<link rel="stylesheet" href="<?php echo e(asset('frontend/css/line-awesome.min.css')); ?>" type="text/css" media="none" onload="if(media!='all')media='all'">
<link rel="stylesheet" href="<?php echo e(asset('css/bootstrap-datepicker.min.css')); ?>" type="text/css" media="none" onload="if(media!='all')media='all'">

<link type="text/css" href="<?php echo e(asset('frontend/css/bootstrap-tagsinput.css')); ?>" rel="stylesheet" media="none" onload="if(media!='all')media='all'">
<link type="text/css" href="<?php echo e(asset('frontend/css/jodit.min.css')); ?>" rel="stylesheet" media="none" onload="if(media!='all')media='all'">
<link type="text/css" href="<?php echo e(asset('frontend/css/sweetalert2.min.css')); ?>" rel="stylesheet" media="none" onload="if(media!='all')media='all'">
<link type="text/css" href="<?php echo e(asset('frontend/css/slick.css')); ?>" rel="stylesheet" media="all">
<link type="text/css" href="<?php echo e(asset('frontend/css/xzoom.css')); ?>" rel="stylesheet" media="none" onload="if(media!='all')media='all'">
<link type="text/css" href="<?php echo e(asset('frontend/css/jssocials.css')); ?>" rel="stylesheet" media="none" onload="if(media!='all')media='all'">
<link type="text/css" href="<?php echo e(asset('frontend/css/jssocials-theme-flat.css')); ?>" rel="stylesheet" media="none" onload="if(media!='all')media='all'">
<link type="text/css" href="<?php echo e(asset('frontend/css/intlTelInput.min.css')); ?>" rel="stylesheet" media="none" onload="if(media!='all')media='all'">
<link type="text/css" href="<?php echo e(asset('css/spectrum.css')); ?>" rel="stylesheet" media="none" onload="if(media!='all')media='all'">
<link rel="stylesheet" type="text/css" href="//cdn.jsdelivr.net/bootstrap.daterangepicker/2/daterangepicker.css" >

<!-- Global style (main) -->
<link type="text/css" href="<?php echo e(asset('frontend/css/active-shop.css')); ?>" rel="stylesheet" media="all">


<link type="text/css" href="<?php echo e(asset('frontend/css/main.css')); ?>" rel="stylesheet" media="all">

<?php if(\App\Language::where('code', Session::get('locale', Config::get('app.locale')))->first()->rtl == 1): ?>
     <!-- RTL -->
    <link type="text/css" href="<?php echo e(asset('frontend/css/active.rtl.css')); ?>" rel="stylesheet" media="all">
<?php endif; ?>

<!-- color theme -->
<link href="<?php echo e(asset('frontend/css/colors/'.\App\GeneralSetting::first()->frontend_color.'.css')); ?>" rel="stylesheet" media="all">

<!-- Custom style -->
<link type="text/css" href="<?php echo e(asset('frontend/css/custom-style.css')); ?>" rel="stylesheet" media="all">
...
<script src="<?php echo e(asset('frontend/js/jssocials.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('frontend/js/lazysizes.min.js')); ?>"></script>
<script src="<?php echo e(asset('frontend/js/intlTelInput.min.js')); ?>"></script>
...
<script>
    ...
    function addToListCart(key){
        ...
        if(checkAddToCartValidity()) {
            $('#addToCart').modal();
            $('.c-preloader').show();
            $.post('<?php echo e(route('cart.addToCart')); ?>', { _token : '<?php echo e(@csrf_token()); ?>', id : key}, function(data){
                   $('#addToCart-modal-body').html(null);
                   $('.c-preloader').hide();
                   $('#modal-size').removeClass('modal-lg');
                   $('#addToCart-modal-body').html(data);
...
<?php /**PATH /home/idevsoft/faizanbd.com/resources/views/frontend/layouts/app.blade.php ENDPATH**/ ?>