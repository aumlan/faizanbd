                    ...
                    <div class="main-content">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <h2 class="heading heading-6 text-capitalize strong-600 mb-0">
                                        <?php echo e(__('Shop Verification')); ?>
                        ...
                        <form class="" action="<?php echo e(route('shop.verify.store')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="text-right mt-4">
                                <button type="submit" class="btn btn-styled btn-base-1"><?php echo e(__('Apply')); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idevsoft/faizanbd.com/resources/views/frontend/seller/verify_form.blade.php ENDPATH**/ ?>