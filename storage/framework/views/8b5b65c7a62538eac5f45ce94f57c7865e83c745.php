            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    <select class="form-control demo-select2"  data-minimum-results-for-search="Infinity" id="update_delivery_status">
                        ...
                        <option value="returned" <?php if($delivery_status == 'returned'): ?> selected <?php endif; ?>>Returned</option>
                    </select>
                </div>
            </div>
            <hr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($orderDetail->product != null): ?>
                    						<a href="<?php echo e(route('product', $orderDetail->product->slug)); ?>" target="_blank"><img height="50" src=<?php echo e(asset($orderDetail->product->featured_img)); ?>/></a>
                                        <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idevsoft/faizanbd.com/resources/views/orders/show.blade.php ENDPATH**/ ?>