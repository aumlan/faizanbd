...
<div class="panel">
            ...
            <form class="" id="sort_products" action="" method="GET">
                ...
                <div class="box-inline pad-rgt pull-left">
                    <div class="" style="min-width: 200px;">
                        <input type="text" class="form-control" id="search" name="search"<?php if(isset($sort_search)): ?> value="<?php echo e($sort_search); ?>" <?php endif; ?> placeholder="Type & Enter" onkeyup="search_products()">
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="panel-body">
        <table class="table mar-no demo-dt-basic" id="" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th>#</th>
                    <th>SKU</th>
                        ...
                        <td>
                            <a href="<?php echo e(route('product', $product->slug)); ?>" target="_blank" class="media-block">
                                <div class="media-left">
                                    <img loading="lazy"  class="img-md" src="<?php echo e(asset($product->featured_img)); ?>" alt="Image">
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idevsoft/faizanbd.com/resources/views/products/index.blade.php ENDPATH**/ ?>