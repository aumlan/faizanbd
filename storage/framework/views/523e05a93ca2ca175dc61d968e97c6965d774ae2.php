                                    ...
                                    <table class="table table-bordered compare-table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <?php $__currentLoopData = Session::get('compare'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <td>
                                                        <img loading="lazy"  src="<?php echo e(asset(\App\Product::find($item)->featured_img)); ?>" alt="Product Image" class="img-fluid py-4">
                                                    </td>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </tr>
                                            <tr>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idevsoft/faizanbd.com/resources/views/frontend/view_compare.blade.php ENDPATH**/ ?>