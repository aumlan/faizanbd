                ...
                <div class="col-md-6">
                    <div class="d-flex">
                        <img
                            ...
                            data-src="<?php if($shop->logo !== null): ?> <?php echo e(asset($shop->logo)); ?> <?php else: ?> <?php echo e(asset('frontend/images/placeholder.jpg')); ?> <?php endif; ?>"
                    ...
                    <div class="slick-carousel" data-slick-arrows="true" data-slick-dots="true">
                        <?php if($shop->sliders != null): ?>
                            <?php $__currentLoopData = json_decode($shop->sliders); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="">
                                    <img class="d-block w-100 lazyload" src="<?php echo e(asset('frontend/images/placeholder-rect.jpg')); ?>" data-src="<?php echo e(asset($slide)); ?>" alt="<?php echo e($key); ?> slide" style="max-height:300px;">
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                        <div class="">
                           
                            <?php if($img=\App\Banner::where('position', '100')->first()): ?>
                            
                                    <img class="d-block w-100 lazyload" src="<?php echo e(asset('frontend/images/placeholder-rect.jpg')); ?>" data-src="<?php echo e(asset($img->photo)); ?>" alt="slide" style="max-height:300px;">
                                </div>
                                <?php endif; ?>
                        <?php endif; ?>
                                            ...
                                            <div class="card-body p-0">
                                                ...
                                                <div class="card-image">
                                                    <a href="<?php echo e(route('product', $product->slug)); ?>" class="d-block">
                                                        <img  class="mx-auto img-fit lazyload" src="<?php echo e(asset('frontend/images/placeholder.jpg')); ?>" data-src="<?php echo e(asset($product->featured_img ?? $product->thumbnail_img)); ?>" alt="<?php echo e(__($product->name)); ?>">
                                                    </a>
                                                </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idevsoft/faizanbd.com/resources/views/frontend/seller_shop.blade.php ENDPATH**/ ?>