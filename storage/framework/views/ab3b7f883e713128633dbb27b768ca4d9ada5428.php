                                ...
                                <div class="col-md-6 col-12">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a href="<?php echo e(route('withdraw_requests.index')); ?>"><?php echo e(__('Money Withdraw')); ?></a></li>
                                        </ul>
                                        <br>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 offset-md-2">
                                <div class="dashboard-widget text-center green-widget text-white mt-4 c-pointer">
                                    ...
                                    <span class="d-block sub-title"><?php echo e(__('Pending Balance')); ?></span>
                            ...
                            <div class="col-md-4">
                                <div class="dashboard-widget text-center plus-widget mt-4 c-pointer" onclick="show_request_modal()">
                                    ...
                                    <span class="d-block title heading-6 strong-400 c-base-1"><?php echo e(__('Send Withdraw Request')); ?></span>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if($seller_withdraw_request->status == 1): ?>
                                                            <span class="ml-2" style="color:green"><strong><?php echo e(__('SENT')); ?></strong></span>
                                                        <?php else: ?>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom product-modal" id="modal-size" role="document">
            <div class="modal-content position-relative">
                <div class="modal-header">
                    <h5 class="modal-title strong-600 heading-5"><?php echo e(__('Send A Withdraw Request')); ?></h5>
                    ...
                    <form class="" action="<?php echo e(route('withdraw_requests.store')); ?>" method="post">
                        ...
                        <div class="modal-body gry-bg px-3 pt-3">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" class="form-control mb-3" name="amount" min="1" max="<?php echo e(Auth::user()->seller->admin_to_pay); ?>" placeholder="Amount" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-base-1"><?php echo e(__('Send')); ?></button>
                        </div>
                    </form>
                <?php else: ?>
                    <div class="modal-body gry-bg px-3 pt-3">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idevsoft/faizanbd.com/resources/views/frontend/seller/seller_withdraw_requests/index.blade.php ENDPATH**/ ?>