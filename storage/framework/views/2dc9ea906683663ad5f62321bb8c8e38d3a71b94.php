                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card-image">
                                            <a href="<?php echo e(route('product', $product->slug)); ?>" class="d-block text-center" >
                                                <img class="img-fit lazyload" src="<?php echo e(asset('frontend/images/placeholder.jpg')); ?>" data-src="<?php echo e(asset($product->flash_deal_img ?? $product->featured_img)); ?>" alt="<?php echo e(__($product->name)); ?>">
                                            </a>
                                        </div>

                                        <div class="p-3" style="padding-bottom: 5px !important;">
                                            <div class="price-box">
                                        ...
                                        <div class="mb-2">
                                            <form id="option-list-form">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="id" value="<?php echo e($product->id); ?>">
                                        <button type="button" class="btn btn-styled btn-alt-base-1 c-white btn-icon-left strong-700 hov-bounce hov-shaddow ml-2 add-to-cart" onclick="addToListCart(<?php echo e($product->id); ?>)">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idevsoft/faizanbd.com/resources/views/frontend/flash_deal_details.blade.php ENDPATH**/ ?>