...
Route::post('/cart/added-cart-items', 'CartController@updateAddedCart')->name('cart.added_cart');
Route::post('/cart/show-cart-modal', 'CartController@showCartModal')->name('cart.showCartModal');
Route::post('/cart/addtocart', 'CartController@addToCart')->name('cart.addToCart');
Route::post('/cart/removeFromCart', 'CartController@removeFromCart')->name('cart.removeFromCart');
Route::post('/cart/updateQuantity', 'CartController@updateQuantity')->name('cart.updateQuantity');

Route::post('/cart/updatePrice', 'CartController@updatePrice')->name('cart.updatePrice');
Route::post('/cart/updateShipping', 'CartController@updateShipping')->name('cart.updateShipping');
...
Route::get('/checkout/{shipping_area?}', 'CheckoutController@get_shipping_info')->name('checkout.shipping_info');
...
Route::group(['middleware' => ['auth']], function(){
	...
	Route::get('/orders/destroy/{id}', 'OrderController@destroy')->name('user.order.edit');
...
Route::post('shop/urlcheck', 'ShopController@check')->name('shop_url.check');
...
Route::post('/addresses/city', 'AddressController@city_by_region')->name('region.city_by_region');
Route::post('/addresses/area', 'AddressController@area_by_city')->name('city.area_by_city');
