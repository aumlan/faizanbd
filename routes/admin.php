...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::post('/menu/featured', 'MenuController@updateFeatured')->name('menu.featured');
    ...
    Route::resource('reseller_deals','ResellerDealController');
    Route::get('/reseller_deals/destroy/{id}', 'ResellerDealController@destroy')->name('reseller_deals.destroy');
	Route::post('/reseller_deals/update_status', 'ResellerDealController@update_status')->name('reseller_deals.update_status');
	Route::post('/reseller_deals/product_discount', 'ResellerDealController@product_discount')->name('reseller_deals.product_discount');
	...
	Route::get('conversations/destroy/{id}', 'ConversationController@destroy')->name('conversations.admin_destroy');
	...
	//Shop Banner
	Route::get('/shop/default/slider', 'SellerController@defaultimg')->name('shop_default_slider');
	Route::post('/shop/default/slider/{id}', 'SellerController@defaultimgpost')->name('shop_default_slider_post');
	Route::post('/shop/url', 'SellerController@slug')->name('sellers.shopurl_modal');
	Route::post('/shop/url/update', 'ShopController@slug')->name('sellers.slug.update');
